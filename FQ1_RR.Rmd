...
mutate(Chr6 = as.numeric(geno_table[, "Chr6:20652277"]),
Chr4 = as.numeric(geno_table[, "Chr4:5383224"]),
Chr5 = as.numeric(geno_table[, "Chr5:14295930"])) |>
pivot_longer(cols = Chr6:Chr5, names_to = "loci", values_to = "frequency")
...
ggsave("../freq_plot.png", p1, width = 12, height = 6)
```
